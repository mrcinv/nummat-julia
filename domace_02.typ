...
Tokratna domača naloga ima dve vrsti nalog.
Prva vrsta zahteva program za računanje vrednosti dane funkcije $f lr((x))$,
druga vrsta pa izračun ene same številke. Obe nalogi reši na
...
implementiraš, ampak da uporabiš znanje lastno, čeprav na koncu rešitev morda ne
bo optimalna. Uporabiš lahko
